...
export default async function handler(req,res){
 ...
 if(!base||!key)return res.status(500).json({error:'Supabase server environment variables are missing'});
 try{
